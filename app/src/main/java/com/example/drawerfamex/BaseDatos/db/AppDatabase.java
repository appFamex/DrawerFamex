...
@Database(entities = {Pantalla.class, fichaPabellon.class, fichaChalets.class, fichaExpo.class, fichaConferencia.class, fichaHoteles.class, fichaInicio.class, fichaAnuncio.class, fichaCustomers.class}, version = 6)
...
public abstract class AppDatabase extends RoomDatabase {
    ...
    //NUEVA API Variables
    public abstract fichasCustomersDao fichasCustomersDao();
    //
